...
import io.bloomish.api.engine.event.data.client.model.item.strategy.*;
import org.jetbrains.annotations.NotNull;

import java.util.function.Consumer;
import java.util.function.Supplier;

import static io.bloomish.api.engine.event.data.client.model.item.ItemModelContainer.*;
