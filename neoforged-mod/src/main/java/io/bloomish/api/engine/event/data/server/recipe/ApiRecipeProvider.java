package io.bloomish.api.engine.event.data.server.recipe;

import io.bloomish.api.engine.event.data.server.recipe.description.*;
import io.bloomish.api.engine.event.data.server.recipe.strategy.*;
