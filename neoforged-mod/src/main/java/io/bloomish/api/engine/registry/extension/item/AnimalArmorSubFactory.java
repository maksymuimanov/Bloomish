...
public interface AnimalArmorSubFactory {
    default DeferredItem<AnimalArmorItem> createAnimalArmor(String name, Holder<ArmorMaterial> material, AnimalArmorItem.BodyType type, boolean hasOverlay) {
