...
public class InitializationLayerCustomizer implements LayerCustomizer<InitializationLayer> {
    ...
    private static final List<ObjectRegistryInitializer> DEFAULT_INITIALIZERS = List.of(new GsonInitializer(), new TemporalRegisterInitializer(), new FactoryInitializer(), new EventBusInitializer(), new ModContainerInitializer(), new InjectedInitializer(), new StrategyInitializer(), new HandlerInitializer(), new ProcessorInitializer());
